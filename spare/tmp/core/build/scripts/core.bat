...
set CLASSPATH=%APP_HOME%\lib\SaveTheKing-1.0.0.jar;%APP_HOME%\lib\gdx-1.12.1.jar;%APP_HOME%\lib\gdx-jnigen-loader-2.3.1.jar


@rem Execute core
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CORE_OPTS%  -classpath "%CLASSPATH%" savetheking.game.Main %*
